...
import static io.quarkiverse.github.pm.util.MessageIcons.ERROR_ICON;
import static io.quarkiverse.github.pm.util.MessageIcons.WARN_ICON;

import java.io.PrintWriter;
import java.text.MessageFormat;

import io.quarkiverse.ai.github.util.AppLogger;
import io.quarkiverse.github.pm.AiGithub;
import picocli.CommandLine;
import picocli.CommandLine.Help.ColorScheme;
import picocli.CommandLine.Model.CommandSpec;

public class OutputMixin implements AppLogger {
    ...
    private static OutputMixin getOutput(CommandSpec commandSpec) {
        return ((AiGithub) commandSpec.root().userObject()).getOutput();
    }
